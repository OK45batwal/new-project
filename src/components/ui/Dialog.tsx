...
export const Dialog: React.FC<DialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto no-print">
      ...
      <div
        className={`relative w-full ${sizeClasses[size]} my-auto bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl shadow-2xl z-10 flex flex-col max-h-[88vh] overflow-hidden animate-scale-in`}
      >
        {/* Header (Sticky Top) */}
