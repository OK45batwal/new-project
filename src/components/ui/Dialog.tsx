...
export const Dialog: React.FC<DialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 overflow-hidden no-print">
      {/* Backdrop Overlay */}
      <div
        onClick={onClose}
      ...
      >
        ...
        {/* Scrollable Content Body with flex-1 min-h-0 */}
        ...
        {footer && (
          <div className="px-6 py-3.5 border-t border-slate-100 dark:border-slate-800 bg-slate-50/90 dark:bg-slate-900/90 backdrop-blur-sm flex items-center justify-end gap-3 flex-shrink-0">
            {footer}
          </div>
        )}
      </div>
